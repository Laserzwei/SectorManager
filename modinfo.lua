...
meta =
{
    ...
    title = "Laserzwei's Sector Manager",

    -- Description of your mod that will be displayed to players
    description = "This mod allows players to load a different set of sector than the automatic vanilla sector loading mechanic.",
